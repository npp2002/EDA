...
optimal_lambda <- cv.obj$lambda.min

ridge_coef <- coef(ridge_mod,s=0.06) #coef() function is used to obtain the coefficients for the ridge regression with lambda = 0.1. 
