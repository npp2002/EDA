...
#over years, look at top ten genres and how the number of owners increases or decreases over time with a heat map. This can be a follow-up question without code for now. 
...
#can do a heat map, looking at proportion of negative ratings for release year and price
...
# **FOLLOW-UP QUESTION/CODE: How does price of video games change across month and year?**
