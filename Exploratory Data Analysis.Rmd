...
tag_data <- read.csv("steamspy_tag_data.csv")
...
# **QUESTION 5: Is there a correlation between the latest update and the number of negative ratings for a game?**

```{r}

```

# **QUESTION 6: Is there a correlation between required age to play the game and the number of achievements?**
...
# **QUESTION 8: Are negative ratings higher for games that have a higher price?**
